...
def get_bet():
    while True: 
        amount = input("What would you like to be on each line? $: ")
        if amount.isdigit(): 
            amount = int(amount)
...
def spin(balance): 
    ...
    while True: 
        ...
        if total_bet > balance:
            print(f"You donot have enough to bet that amount, your current balance is: ${balance}. Still want to play?")
            deposit()
        else:
            break
